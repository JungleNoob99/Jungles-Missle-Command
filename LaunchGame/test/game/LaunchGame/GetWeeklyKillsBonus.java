...
public class GetWeeklyKillsBonus {
    ...
    public void test()
    {
        ...
        assertEquals(100, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(200, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(200, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(300, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(300, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(300, game.GetWeeklyKillsBonus(player));
        ...
        assertEquals(300, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(400, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(400, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(400, game.GetWeeklyKillsBonus(player));
        ...
        assertEquals(400, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(500, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(500, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(500, game.GetWeeklyKillsBonus(player));
        ...
        assertEquals(500, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(600, game.GetWeeklyKillsBonus(player));
    }
}
